...
public:
    ...
    // m1 + poly
    Ciphertext addConst(Ciphertext& cipher, ZZX& poly, long logp);
    
    void addConstAndEqual(Ciphertext& cipher, ZZX& poly, long logp);

    
    // poly - m1
    Ciphertext subConst2(Ciphertext& cipher, ZZX& poly, long logp);

    void subConstAndEqual2(Ciphertext& cipher, ZZX& poly, long logp);
